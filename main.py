...
def agregar_gasto():
    ...
    print(registro_gastos)
    save_db(registro_gastos)
...
def modificar_gasto():
    ...
    if nombre in registro_gastos:
        ...
        if atributo == "1":
            ...
            nuevo_monto = (input("Ingrese el nuevo monto: "))
            registro_gastos[nombre]["monto"] = nuevo_monto
            save_db(registro_gastos)

        elif atributo == "3":
            nuevo_tipo = input("Ingrese la nueva tipo: ")
            registro_gastos[nombre]["tipo"] = nuevo_tipo
            save_db(registro_gastos)
